...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <form
        onSubmit={onSubmit}
        className="bg-white w-full max-w-sm p-6 rounded-lg shadow-box space-y-4"
      >
        ...
        <button
          disabled={loading}
          className="w-full bg-teal-500 hover:bg-teal-600 text-white py-2 rounded-lg disabled:opacity-60"
        >
          {loading ? '...' : 'ورود'}
        </button>
      </form>
